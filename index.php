...
<nav class="menu-bar">
    ...
    <li class="active"><a href="../Cyber-Gear/cryptography.html">Cryptography</a></li>
    </ul>
</nav>  

<main>
    <section>
    <h1>Tools Categories</h1>
    <p>Below are categorized tools commonly used for various purposes, including cybersecurity, data analysis, and system optimization. Each category highlights reliable and widely used tools across different platforms and operating systems.</p>
    ...
    <div id="linux" class="os-section">
        ...
        <div class="tool-item">
            ...
            <h3><a href="https://gnupg.org" target="_blank">Network Security</a></h3>
        ...
        <div class="tool-item">
            ...
            <h3><a href="https://www.openssl.org" target="_blank">Vulnerability Assesment</a></h3>
        ...
        <div class="tool-item">
            ...
            <h3><a href="https://gitlab.com/cryptsetup/cryptsetup" target="_blank">OSINT</a></h3>
        ...
        <div class="tool-item">
            ...
            <h3><a href="https://gitlab.com/cryptsetup/cryptsetup" target="_blank">Forensic</a></h3>
        ...
        <div class="tool-item">
            ...
            <h3><a href="https://gitlab.com/cryptsetup/cryptsetup" target="_blank">Cryptography</a></h3>
